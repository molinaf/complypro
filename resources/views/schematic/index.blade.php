...
<link rel="stylesheet" href="{{ asset('schematic/css/style.css') }}">
</head>
<body>
...
<br>
<script src="{{ asset('schematic/js/schematicMNA.js') }}"></script>
...
<img src="{{ asset('schematic/img/Volt-Meter.png') }}" alt="Volt Meter" class="voltMeter" id="voltMeter">
...
<img src="{{ asset('schematic/img/black-probe.png') }}" alt="Black Probe" class="draggable" id="draggableImageBlack" style="position: absolute; top: 550px; left: 130px;">
<img src="{{ asset('schematic/img/red-probe.png') }}" alt="Red Probe" class="draggable" id="draggableImageRed" style="position: absolute; top: 550px; left: 30px;">
...
<script src="{{ asset('schematic/js/probes.js') }}"></script>
</body>
</html>