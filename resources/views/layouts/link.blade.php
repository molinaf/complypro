...
<header class="bg-blue-900 text-white">
    <div class="text-center py-1 bg-blue-900">
        <h1 class="text-2xl ">Required Links to Authorisations</h1>
    </div>
    <!-- Navbar -->
    <nav class="container mx-auto flex max-w-7xl items-center justify-between px-7 py-1 lg:px-8">
        ...
        <div class="flex items-center justify-between w-full">
            ...
            <div id="navbar-links" class="hidden sm:flex flex-row flex-wrap md:space-x-4 md:items-center w-full text-lg py-2">
                <a href="/link_table/module" class="block px-1 py-2 hover:text-blue-600">Module</a>
                <a href="/link_table/f2f" class="block px-1 py-2 hover:text-blue-600">Face2Face</a>
                <a href="/link_table/induction" class="block px-1 py-2 hover:text-blue-600">Inductions</a>
                <a href="/link_table/license" class="block px-1 py-2 hover:text-blue-600">Licenses</a>
                <div class="block px-1 py-2" >|</div>
                <a href="/relate_table" class="block px-1 py-2 hover:text-blue-600">Show-links</a>
            </div>
